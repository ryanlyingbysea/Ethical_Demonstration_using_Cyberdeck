...
class jammer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.wifi = wifi = 2.437e9
        self.samp_rate = samp_rate = 2e7
        ...
        self.osmosdr_sink_0.set_center_freq(wifi, 0)
        self.osmosdr_sink_0.set_freq_corr(0, 0)
        self.osmosdr_sink_0.set_gain(50, 0)
        self.osmosdr_sink_0.set_if_gain(20, 0)
        self.osmosdr_sink_0.set_bb_gain(20, 0)
        self.osmosdr_sink_0.set_antenna('', 0)
        self.osmosdr_sink_0.set_bandwidth(2e7, 0)
    ...
    def set_wifi(self, wifi):
        self.wifi = wifi
        self.osmosdr_sink_0.set_center_freq(self.wifi, 0)
        self.qtgui_sink_x_0.set_frequency_range(self.wifi, 50e6)
