...
class BLEreceiver(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "BLEreceiver", catch_exceptions=True)
        ...
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_char, 1, 'tcp://127.0.0.1:55556', 100, False, (-1), '', True, True)
...
def main(top_block_cls=BLEreceiver, options=None):
    tb = top_block_cls()
